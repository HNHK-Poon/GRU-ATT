...
parser.add_argument('--drp', metavar='D', default=0.5, type=float,
...
def virtual_adversarial_loss(x, logit, is_training=True, name="vat_loss"):
    ...
    vat_loss, vat_perturbation = VAT(batch_embedded_sent, keep_prob=keep_prob)
    ...
    vat_loss_sent, vat_perturbation_sent = VAT(sent_perturbated, keep_prob=keep_prob)
    ...
    loss = cl_loss + ad_loss + ad_loss_sent + vat_loss + vat_loss_sent
