...
with tf.Session(graph=graph,config=config) as sess:
    ...
    out_dir = 'log_adv_vir_han_amazon_2/'+ hyperparameter +'/'
    ...
    with open('log_adv_vir_han_amazon_2/'+ hyperparameter +'.txt', 'w') as log_file:
        ...
        for e in range(epochs):
            ...
            '''
            print("Epoch finished, time consumed : ", time.time() - epoch_start)
